...
- [ ] textname не отображается в графиках и IO - использовать comment как fallback
- [ ] LogServer: добавить все параметры (sessMaxCount, список сессий)
- [ ] Переменные не вошедшие в io/Variables выводить в разделе Настройки
- [ ] Входы/Выходы: столбец описание разместить в конце
