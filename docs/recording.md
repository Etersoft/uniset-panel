...
Примечание: в старых данных или при смешанном источнике записи может встречаться префикс `ext:` для OPCUA.
...
1. При записи периодически (раз в ~1 минуту) проверяется количество записей
