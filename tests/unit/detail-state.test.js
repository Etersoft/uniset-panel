...
describe('detailStateDefault', () => {
    it('shape covers all required fields', () => {
        ...
        expect(d).toMatchObject({
            ...
            logPaused: false,
            logEnabled: false,
            varsCollapsed: { inputs: false, outputs: false, locals: true }
        });
    });
});
...
describe('loadDetailState / saveDetailState', () => {
    it('round-trip persists fields verbatim', () => {
        const state = {
            ...
            trendsWindow: 300, logFilter: 'sensor',
            logFilterRegex: true, logFilterCase: false,
            logSize: 512,
            logPaused: true, logEnabled: true,
            varsCollapsed: { inputs: true, outputs: false, locals: false }
        };
